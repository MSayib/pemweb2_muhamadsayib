...
$pasien1 = new Pasien('Sayib', 'P001', 'L');
$pasien2 = new Pasien('Fikri', 'P002', 'L');
$pasien3 = new Pasien('Lala', 'P003', 'P');

$bmi1 = new BMI(58, 160);
$bmi2 = new BMI(66, 167);
$bmi3 = new BMI(53, 162);

$pasienbmi1 = new BMIPasien($bmi1, '01-01-2022', $pasien1);
$pasienbmi2 = new BMIPasien($bmi2, '01-01-2022', $pasien2);
$pasienbmi3 = new BMIPasien($bmi3, '01-01-2022', $pasien3);
